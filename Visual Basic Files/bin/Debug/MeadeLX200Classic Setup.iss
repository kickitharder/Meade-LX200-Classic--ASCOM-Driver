...
; Generated by Keith Rickard on 08/05/2021 (UTC)
;
[Setup]
AppID={{4f63a7d0-717b-40fd-aab0-6bcde48306c4}
AppName=ASCOM MeadeLX200Classic Telescope Driver
AppVerName=ASCOM MeadeLX200Classic Telescope Driver 1.210425
AppVersion=1.210425
AppPublisher=Keith Rickard <keithrickard@hotmail.com>
AppPublisherURL=mailto:keithrickard@hotmail.com
...
OutputDir="."
OutputBaseFilename="MeadeLX200Classic Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Telescope\MeadeLX200Classic"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Telescope\MeadeLX200Classic"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\Google Drive\Development\Repositories\LX200Classic\Meade LX200 Classic ASCOM Driver\Visual Basic Files\bin\Debug\ASCOM.LX200Classic.Telescope.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Google Drive\Development\Repositories\LX200Classic\Meade LX200 Classic ASCOM Driver\Visual Basic Files\MeadeLX200ClassicReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.LX200Classic.Telescope.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.LX200Classic.Telescope.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.LX200Classic.Telescope.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.LX200Classic.Telescope.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.LX200Classic.Telescope.dll"""; Flags: runhidden 64bit; Check: IsWin64
