...
'
' ASCOM Telescope driver for LX200Classic
'
...
'
' Implements:	ASCOM Telescope interface version.0
...
'
'
' Your driver's ID is ASCOM.LX200Classic.Telescope
'
...
<Guid("8d687130-3fb9-46e3-a9a7-74ee278c04af")>
<ClassInterface(ClassInterfaceType.None)>
Public Class Telescope

    ' The Guid attribute sets the CLSID for ASCOM.LX200Classic.Telescope
    ' The ClassInterface/None attribute prevents an empty interface called
    ' _LX200Classic from being created and used as the [default] interface
    ...
    '
    Friend Shared driverID As String = "ASCOM.LX200Classic.Telescope"
    Private Shared driverDescription As String = "Meade LX200 Classic"

    Friend Shared comPortProfileName As String = "COM Port" 'Constants used for Profile persistence
    Friend Shared traceStateProfileName As String = "Trace Level"
    Friend Shared homePositionHAName As String = "Home Position Azimuth"
    Friend Shared homePositionDECName As String = "Home Position Altitude"
    ...
    Public Sub New()
        ...
        TL = New TraceLogger("", "LX200 Classic")
...
#Region "ITelescope Implementation"
    ...
    Public Sub FindHome() Implements ITelescopeV3.FindHome
        ...
        lxTargetRA = Norm24(homePositionHA + HMS2Hrs(LongFormat("GS")))
    ...
    Public Sub Park() Implements ITelescopeV3.Park
        ...
        If Not AtPark Then
            ...
            For i = 1 To 3                                                  ' Slew to home 3 times for accuracy
                TL.LogMessage(Space(pad) + "i", i.ToString)
                parkRA = Norm24(homePositionHA + HMS2Hrs(LongFormat("GS"))) ' Calculate home position RA
    ...
    Public ReadOnly Property RightAscension() As Double Implements ITelescopeV3.RightAscension
        Get
            ...
            Dim RA As Double
            If AtPark Then
                RA = Norm24(homePositionHA + HMS2Hrs(LongFormat("GS")))
            Else
    ...
    Public Sub SetPark() Implements ITelescopeV3.SetPark
        ...
        homePositionHA = HMS2Hrs(LongFormat("GR")) - HMS2Hrs(LongFormat("GS"))  ' Subtract Sid Time from RA to get Hour Angle
        homePositionDEC = Int(homePositionDEC + 0.5)
        homePositionHA = Int(homePositionHA * 10) / 10
        WriteProfile()
...
#Region "My Stuff"
    Private Function SerialCommand(cmdStr As String, n As Integer) As String
        ...
        'Telescope.comPort = "COM2"      ' REMOVE THIS LINE FOR FINAL VERSION!!!
