...
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.LX200Classic.Telescope.Rate
' The ClassInterface/None attribute prevents an empty interface called
' _Rate from being created and used as the [default] interface
'
<Guid("f6f4c2ee-652d-4f9e-a202-25d2a5e573bd")>
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.LX200Classic.Telescope.AxisRates
' The ClassInterface/None attribute prevents an empty interface called
' _AxisRates from being created and used as the [default] interface
'
<Guid("d61e1689-6b6c-41cd-8be0-f53c7f2619c4")>
<ClassInterface(ClassInterfaceType.None)>
<ComVisible(True)>
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.LX200Classic.Telescope.TrackingRates
' The ClassInterface/None attribute prevents an empty interface called
' _TrackingRates from being created and used as the [default] interface
'
<Guid("a59bc83e-32e4-4c52-b810-42b75757304e")>
<ClassInterface(ClassInterfaceType.None)>
<ComVisible(True)>
